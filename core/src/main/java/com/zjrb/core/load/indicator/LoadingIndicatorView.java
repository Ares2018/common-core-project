...
public class LoadingIndicatorView extends View implements UiModeChangeListener {
    ...
    private Integer mColorAttrId = null;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor = a.getColor(R.styleable.LoadingIndicatorView_indicatorColor, Color
                .WHITE);
    ...
    public void setIndicator(String indicatorName) {
        ...
        try {
            ...
            L.e(TAG, "Didn't find your class , check the name again !");
    ...
    public void onUiModeChange() {
        if (mColorAttrId != null) {
            Resources.Theme theme = getContext().getTheme();
            if (theme != null && theme.resolveAttribute(mColorAttrId, sOutValue, true)) {
                switch (sOutValue.type) {
                    case TypedValue.TYPE_INT_COLOR_ARGB4:
                    case TypedValue.TYPE_INT_COLOR_ARGB8:
                    case TypedValue.TYPE_INT_COLOR_RGB4:
                    case TypedValue.TYPE_INT_COLOR_RGB8:
                        setIndicatorColor(sOutValue.data);
                        break;
                    case TypedValue.TYPE_STRING:
                        setIndicatorColor(ContextCompat.getColor(getContext(),
