 ...
 * @date 2017/9/5 11:30.
 */
public class LoadAnim extends AppCompatImageView implements Animatable, UiModeChangeListener {
    ...
    public LoadAnim(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LoadAnim(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
