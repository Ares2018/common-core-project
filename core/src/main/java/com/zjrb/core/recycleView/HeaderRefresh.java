 ...
 * @date 2017/8/4 13:48.
 */
public class HeaderRefresh extends PageItem {
...
//                                rv.scrollToPosition(0);
    ...
    public HeaderRefresh(RecyclerView recycler) {
        this(recycler, null);
    }

    public HeaderRefresh(RecyclerView recycler, OnRefreshListener listener) {
