...
public class OverlayItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        if (!(parent.getAdapter() instanceof BaseRecyclerAdapter)) return;
     ...
     * @param adapter              {@link BaseRecyclerAdapter}
     * @param firstVisiblePosition first visible position
     * @return position
     */
    protected int getOverlayPosition(RecyclerView parent, BaseRecyclerAdapter adapter,
